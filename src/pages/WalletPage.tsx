        ...
        <div style={{background:'linear-gradient(135deg,rgba(212,175,55,0.08),rgba(17,17,19,0.98))',
          ...
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:14}}>
            ...
            <div style={{textAlign:'right'}}>
              <p style={{color:'#D4AF37',fontSize:20,fontWeight:900,margin:'0 0 2px',lineHeight:1}}>
                {total}
              </p>
              <p style={{color:'#5A6A79',fontSize:10,margin:0}}>referrals</p>
            </div>
          </div>
          ...
          {referralLink && (
            <div style={{marginBottom:10}}>
              <div style={{background:'rgba(0,0,0,0.4)',border:'1px solid rgba(212,175,55,0.2)',
              ...
              <button onClick={copyLink}
                style={{width:'100%',padding:'12px',borderRadius:12,fontWeight:700,fontSize:13,
          ...
          {referrals.length > 0 && (
            <div>
              <p style={{color:'#5A6A79',fontSize:10,textTransform:'uppercase',
                letterSpacing:'0.08em',margin:'12px 0 8px',fontWeight:700}}>
                Your Referrals
              </p>
                ...
                {referrals.slice(0,5).map((r: Referral) => (
                  <div key={r.telegramId} style={{display:'flex',alignItems:'center',
                    ...
                    <div style={{display:'flex',alignItems:'center',gap:8}}>
                      <div style={{width:28,height:28,borderRadius:8,background:'rgba(212,175,55,0.1)',
